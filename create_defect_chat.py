...
import ClauseResultsCard from "./chat/ClauseResultsCard";
...
with open(r'c:\Users\rudra\Desktop\Waranty_POC\warranty-platform\frontend\src\components\DefectFloatingChat.tsx', 'w', encoding='utf-8') as f:
    f.write(content)
print("Created DefectFloatingChat.tsx")
